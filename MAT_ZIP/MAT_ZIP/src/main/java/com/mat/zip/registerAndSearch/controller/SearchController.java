...
public class SearchController {
	...
	//지도 업데이트 버튼 관련 함수 
	@RequestMapping(value = {"/registerAndSearch/controller/Remap.mz", "/registerAndSearch/controller/autoComplete.mz", "/registerAndSearch/controller/searchResultMarker.mz"})
