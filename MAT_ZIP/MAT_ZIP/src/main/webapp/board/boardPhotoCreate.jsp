...
<head>
  ...
  <!-- 로그인을 하지 않고 접근했을 시 로그인 페이지로 리다이렉트 -->
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        if (!user_id) {
            ...
            window.location.href = "${pageContext.request.contextPath}/mz_member/login"; // 로그인 페이지로 리다이렉트
        }
    });
	</script>
...
<body class="sub_page">
  ...
  <div class="hero_area">
	...
	<br>  
	<h3>사진게시판 - 게시물등록 화면입니다.</h3>
	<hr color="red">
	<form action="insertPhoto" id="form" method="post" enctype="multipart/form-data" >
		회원 ID : <input name="user_id" value="${user_id}" readonly/><br>
		제목 : <input name="photo_title" value=""><br>
		게시물의 사진 카테고리 : <select name="photo_cg">
		...
		내용 : <input name="photo_content" value="" style="width:500px; height:200px;" maxlength=140><br> 
