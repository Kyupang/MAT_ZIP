...
<body class="sub_page">
  ...
  <div class="hero_area">
    ...
    <form action="insertReview" method="post" enctype="multipart/form-data">
		...
		<label for="store_id">영수증 ID : </label>
        <input type="text" id="receipt_id" name="receipt_id" value="${receipt.mzRegisterInfoVO.no}" readonly> <br>
        ...
        <button type="button" onclick="searchEmoji()">이모지 조회하기</button> <br> <br>
