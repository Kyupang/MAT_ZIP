...
<body>
	...
	<div class="container">
		...
		<div class="row">
			...
			<a href="paymentTest.jsp">
				<button class="btn btn-success" style="z-index: 200;">음식결제하러가기</button>
			</a>
			<%
			...
			<h3 style="color: green;">
				<em class="logout"> <a href="logout"><button type="button"
							class="btn btn-danger opacity-75 bi bi-box-arrow-right">
							로그아웃
