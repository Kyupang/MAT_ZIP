	...
	<div class="calendar">
		...
		<div class="today_button_div">
			<button type="button" class="buttonstyle"
				...
				style="height: 30px; width: 200px;">Add Schedule</button>
			...
			<tbody>
				...
				<c:forEach var="dateList" items="${Schedule_list}">
					<tr bgcolor="#A0D9E2">
						...
						<td class="day">${dateList.schedule_subject}</td>
						<td class="day">${dateList.schedule_desc}</td>
						<td class="day">${dateList.schedule_date}</td>
						<td class="day">${dateList.schedule_share == 1 ? "공개" : "비공개"}</td>
						<td class="day"
                            style="background-color: ${dateList.schedule_mycolor}; display: flex; justify-content: center; align-items: center; width: 20px; height: 20px; border: 1px solid white;">
                            <div style="width: 33%; height: 33%;">
                                <i class="color-icon"
                                    style="display: block; width: 100%; height: 100%; background-color: ${dateList.schedule_mycolor};"></i>
                            </div>
                        </td>
